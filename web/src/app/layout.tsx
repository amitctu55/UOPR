...
export const metadata: Metadata = {
  title: { default: "UPCHAR — Enterprise Healthcare Platform", template: "%s · UPCHAR" },
  description: "Secure, scalable healthcare management for patients, doctors, hospitals, and administrators.",
};
