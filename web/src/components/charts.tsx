...
const tooltipStyle = { background: "var(--surface-raised)", border: "1px solid var(--line)", borderRadius: "12px", color: "var(--ink)", fontSize: "12px" };
...
export function RevenueChart({ data }: { data: { month: string; collected: number; outstanding: number }[] }) {
  return (
    <div className="h-64 w-full">
      <ResponsiveContainer width="100%" height="100%">
