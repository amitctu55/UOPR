...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-body-sm font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 focus-visible:shadow-focus",
  {
    variants: {
      variant: {
        primary:
          "bg-brand-600 text-white hover:bg-brand-700 active:scale-[0.98] dark:bg-brand-500 dark:text-brand-900 dark:hover:bg-brand-400",
        secondary:
          "bg-surface-raised text-ink border border-line hover:border-line-strong hover:bg-surface-muted",
